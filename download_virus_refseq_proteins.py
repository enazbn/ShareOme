...
# --- Start search ---
print(f"{timestamp()} Starting Virus RefSeq Protein Download")
...
for start in range(0, count, BATCH_SIZE):
    ...
    while not success and retries < RETRY_LIMIT:
        try:
            ...
            filename = os.path.join(SAVE_DIR, f"virus_refseq_{start+1}_{end}.fasta.gz")
